...
function generateSampleData() {
  ...
  const expenseEntries: ExpenseEntry[] = [
    // January
    { id: id(), type: "rent", description: "Monthly rent", amount: 2200, currency: "AUD", vendor: "REA Group", date: "2026-01-01", notes: "Surry Hills apartment", images: [], createdAt: now },
    { id: id(), type: "food", description: "Woolworths groceries", amount: 145, currency: "AUD", vendor: "Woolworths", date: "2026-01-05", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Weekly groceries", amount: 132, currency: "AUD", vendor: "Coles", date: "2026-01-12", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Dinner with friends", amount: 85, currency: "AUD", vendor: "Thai Pothong", date: "2026-01-18", notes: "", images: [], createdAt: now },
    { id: id(), type: "transport", description: "Opal card top-up", amount: 50, currency: "AUD", vendor: "Opal", date: "2026-01-10", notes: "", images: [], createdAt: now },
    { id: id(), type: "subscriptions", description: "Spotify Premium", amount: 12.99, currency: "AUD", vendor: "Spotify", date: "2026-01-15", notes: "", images: [], createdAt: now },
    { id: id(), type: "subscriptions", description: "Netflix", amount: 22.99, currency: "AUD", vendor: "Netflix", date: "2026-01-15", notes: "", images: [], createdAt: now },
    { id: id(), type: "utilities", description: "Electricity bill", amount: 180, currency: "AUD", vendor: "AGL", date: "2026-01-20", notes: "", images: [], createdAt: now },
    { id: id(), type: "health", description: "Gym membership", amount: 69, currency: "AUD", vendor: "Fitness First", date: "2026-01-01", notes: "", images: [], createdAt: now },
    { id: id(), type: "insurance", description: "Health insurance", amount: 145, currency: "AUD", vendor: "Medibank", date: "2026-01-28", notes: "", images: [], createdAt: now },
    { id: id(), type: "entertainment", description: "Movie tickets", amount: 38, currency: "AUD", vendor: "Event Cinemas", date: "2026-01-25", notes: "", images: [], createdAt: now },

    // February
    { id: id(), type: "rent", description: "Monthly rent", amount: 2200, currency: "AUD", vendor: "REA Group", date: "2026-02-01", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Groceries", amount: 158, currency: "AUD", vendor: "Woolworths", date: "2026-02-03", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Groceries", amount: 121, currency: "AUD", vendor: "Aldi", date: "2026-02-10", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Coffee beans", amount: 42, currency: "AUD", vendor: "Single O", date: "2026-02-14", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Valentine's dinner", amount: 195, currency: "AUD", vendor: "Quay Restaurant", date: "2026-02-14", notes: "", images: [], createdAt: now },
    { id: id(), type: "transport", description: "Opal card", amount: 50, currency: "AUD", vendor: "Opal", date: "2026-02-08", notes: "", images: [], createdAt: now },
    { id: id(), type: "transport", description: "Car rego", amount: 380, currency: "AUD", vendor: "Service NSW", date: "2026-02-15", notes: "Annual", images: [], createdAt: now },
    { id: id(), type: "subscriptions", description: "Spotify + Netflix", amount: 35.98, currency: "AUD", vendor: "Various", date: "2026-02-15", notes: "", images: [], createdAt: now },
    { id: id(), type: "health", description: "Gym", amount: 69, currency: "AUD", vendor: "Fitness First", date: "2026-02-01", notes: "", images: [], createdAt: now },
    { id: id(), type: "shopping", description: "New running shoes", amount: 189, currency: "AUD", vendor: "Nike", date: "2026-02-20", notes: "", images: [], createdAt: now },
    { id: id(), type: "education", description: "Udemy courses", amount: 29.99, currency: "USD", vendor: "Udemy", date: "2026-02-22", notes: "React & TypeScript", images: [], createdAt: now },

    // March
    { id: id(), type: "rent", description: "Monthly rent", amount: 2200, currency: "AUD", vendor: "REA Group", date: "2026-03-01", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Groceries", amount: 167, currency: "AUD", vendor: "Woolworths", date: "2026-03-02", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Groceries", amount: 98, currency: "AUD", vendor: "Aldi", date: "2026-03-09", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Groceries", amount: 143, currency: "AUD", vendor: "Coles", date: "2026-03-16", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Groceries", amount: 112, currency: "AUD", vendor: "Woolworths", date: "2026-03-23", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Brunch with mates", amount: 65, currency: "AUD", vendor: "Bills Surry Hills", date: "2026-03-15", notes: "", images: [], createdAt: now },
    { id: id(), type: "transport", description: "Opal card", amount: 50, currency: "AUD", vendor: "Opal", date: "2026-03-05", notes: "", images: [], createdAt: now },
    { id: id(), type: "transport", description: "Petrol", amount: 95, currency: "AUD", vendor: "7-Eleven", date: "2026-03-18", notes: "", images: [], createdAt: now },
    { id: id(), type: "subscriptions", description: "Spotify + Netflix", amount: 35.98, currency: "AUD", vendor: "Various", date: "2026-03-15", notes: "", images: [], createdAt: now },
    { id: id(), type: "utilities", description: "Internet", amount: 79, currency: "AUD", vendor: "Aussie Broadband", date: "2026-03-10", notes: "", images: [], createdAt: now },
    { id: id(), type: "health", description: "Gym", amount: 69, currency: "AUD", vendor: "Fitness First", date: "2026-03-01", notes: "", images: [], createdAt: now },
    { id: id(), type: "health", description: "Dentist checkup", amount: 220, currency: "AUD", vendor: "Sydney Dental", date: "2026-03-22", notes: "", images: [], createdAt: now },
    { id: id(), type: "insurance", description: "Health insurance", amount: 145, currency: "AUD", vendor: "Medibank", date: "2026-03-28", notes: "", images: [], createdAt: now },
    { id: id(), type: "travel", description: "Weekend trip Blue Mountains", amount: 350, currency: "AUD", vendor: "Airbnb", date: "2026-03-28", notes: "2 nights", images: [], createdAt: now },

    // April
    { id: id(), type: "rent", description: "Monthly rent", amount: 2200, currency: "AUD", vendor: "REA Group", date: "2026-04-01", notes: "", images: [], createdAt: now },
    { id: id(), type: "food", description: "Groceries", amount: 135, currency: "AUD", vendor: "Woolworths", date: "2026-04-01", notes: "", images: [], createdAt: now },
    { id: id(), type: "transport", description: "Opal card", amount: 50, currency: "AUD", vendor: "Opal", date: "2026-04-01", notes: "", images: [], createdAt: now },
    { id: id(), type: "subscriptions", description: "ChatGPT Plus", amount: 20, currency: "USD", vendor: "OpenAI", date: "2026-04-01", notes: "", images: [], createdAt: now },
  ];
